      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-lg-3 text-left">
            <i class="fa fa-map-marker"></i> Purwokerto, Banyumas
          </div>
          <!--== Single HeaderTop End ==-->

          <!--== Single HeaderTop Start ==-->
          <div class="col-lg-3 text-center">
            <i class="fa fa-mobile"></i> 082324600244
          </div>
          <!--== Single HeaderTop End ==-->
          ...
          <div class="col-lg-3 text-right">
            <div class="header-social-icons">
              <a href="https://web.facebook.com/michael.as.921"><i class="fa fa-facebook"></i></a>
              <a href="https://www.instagram.com/michael_as77"><i class="fa fa-instagram"></i></a>
            </div>
          </div>
          <!--== Social Icons End ==-->
        </div>
