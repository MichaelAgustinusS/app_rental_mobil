                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                <p>Webiste ini dibuat oleh Michael Agustinus S untuk mempermudah proses pemesanan mobil.</p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="single-footer-widget">
                            ...
                            <div class="widget-body">
                                ...
                                <ul class="get-touch">
                                    <li><i class="fa fa-map-marker"></i> Purwokerto, Banyumas</li>
                                    <li><i class="fa fa-mobile"></i> 082324600244</li>
                                    <li><i class="fa fa-envelope"></i> mikeas1001@gmail.com</li>
                                </ul>
